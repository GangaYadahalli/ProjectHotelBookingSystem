...
import com.hexaware.hotelbookingsystem.dto.PaymentsDto.PaymentMethod;
...
public class Payments {
	...
	public Payments(Integer paymentId, Double paymentAmount, LocalDateTime paymentDate, PaymentMethod paymentMethod,
			PaymentStatus paymentStatus, String transactionId, String remarks, LocalDateTime createdAt, Users user,
			Bookings booking) {
		super();
		this.paymentId = paymentId;
		this.paymentAmount = paymentAmount;
